...
{
    public partial class ctrlSechduelTest : UserControl
    {
        ...
        private bool _LoadTestAppointmentData()
        {
            ...
            if (DateTime.Compare(DateTime.Now, _TestAppointment.AppoitmentDate) < 0)
                dtpTestDate.MinDate = DateTime.Now;
            else
                dtpTestDate.MinDate = _TestAppointment.AppoitmentDate;

            dtpTestDate.Value = _TestAppointment.AppoitmentDate;
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            if (_Mode == enMode.AddNew)
            {
                ...
                _TestAppointment = new clsTestAppoitments();
            }
        ...
        private void ctrlSechduelTest_Load(object sender, EventArgs e)
        {
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.AppoitmentDate = dtpTestDate.Value;
